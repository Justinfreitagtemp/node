...
proto.getImplementation = function getImplementation () {
  return exports.createUnwrapperFunction(core.method_getImplementation(this.pointer), this.getTypes())
}
...
proto.setImplementation = function setImplementation (func) {
  var types = this.getTypes()
    , wrapperPtr = exports.createWrapperPointer(func, types)
    , oldFuncPointer = core.method_setImplementation(this.pointer, wrapperPtr)
  return exports.createUnwrapperFunction(oldFuncPointer, types)
}
