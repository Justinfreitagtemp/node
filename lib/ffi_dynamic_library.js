var Bindings = require('ffi_bindings')
  , ForeignFunction = require('ffi_foreign_function')
  , read  = require('fs').readFileSync
  , dlopen = ForeignFunction(Bindings.StaticFunctions.dlopen
      , 'pointer', [ 'string', 'int32' ])
  , dlclose = ForeignFunction(Bindings.StaticFunctions.dlclose
      , 'int32', [ 'pointer' ])
  , dlsym = ForeignFunction(Bindings.StaticFunctions.dlsym
      , 'pointer', [ 'pointer', 'string' ])
  , dlerror = ForeignFunction(Bindings.StaticFunctions.dlerror
      , 'string', [ ])
