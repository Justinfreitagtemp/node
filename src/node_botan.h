...
namespace pk {
  ...
  class PublicKey : public node::ObjectWrap {
    public:
      PublicKey(v8::Handle<v8::Object> target, Botan::Public_Key *publicKey);
  ...
  static const std::string FIRST_PASS_CIPHER_TYPE = "AES-256/CBC";
  static const std::string SECOND_PASS_CIPHER_TYPE = "AES-256/EAX";
  ...
  class PrivateKey : public node::ObjectWrap {
    public:
      PrivateKey(v8::Handle<v8::Object> target, Botan::Private_Key *privateKey);
